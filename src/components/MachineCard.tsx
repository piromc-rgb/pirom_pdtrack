      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="grid grid-cols-2 gap-2 my-3 py-2 border-y border-slate-100 text-xs">
          <div className="flex flex-col">
            <span className="text-slate-400">เสร็จแล้ว หรือ ผ่าน QC:</span>
            <span className="font-semibold text-slate-800">
              {machine.completedOrQcItems ?? machine.deliveredItems} / {machine.totalItems} รายการ
            </span>
          </div>
          <div className="flex flex-col">
